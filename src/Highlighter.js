...
class Highlighter extends Component {
  ...
  render() {
    const { selection, value, markup, displayTransform, style, inputStyle } = this.props
    ...
    const mentionIteratee = function (markup, index, indexInPlainText, id, display, type, lastMentionEndIndex) {
  ...
  getMentionComponentForMatch(id, display, type, key) {
    ...
    if (childrenCount === 1) {
      ...
      const child = this.props.children.length ? this.props.children[0] : Children.only(this.props.children)
